...
// have jdbc: mysql usrl of RDS infor to log in
//"jdbc:mysql://myproject-instance.clsrjb6y7wfj.us-west-2.rds.amazonaws.com:3306/juiter?user=admin&password=12345678&autoReconnect=true&serverTimezone=UTC&createDatabaseIfNotExist=true"
public class MySQLDBUtil {
    // RDS ip address
    private static final String INSTANCE = "myproject-instance.clsrjb6y7wfj.us-west-2.rds.amazonaws.com";
